...
export default function PatientLoginPage() {
    ...
    const handleMobileSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Check if mobile number exists in patient data
    ...
    const handleOtpSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Create session
            const session = {
                patientId: patient.credentials.patientId,
                email: patient.credentials.email,
                role: 'PATIENT' as const,
                primaryDiagnosisCategory: patient.patientData.diagnosis.primaryCategory,
                token: `patient_${patient.credentials.patientId}_${Date.now()}`
            }
            ...
            const dashboardRoute = getDashboardRoute(session.primaryDiagnosisCategory)
