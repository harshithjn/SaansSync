// Doctor-Patient Mapping Service
...
// Create/Update Patient Folder
export function createPatientFolder(
    patientData: PatientData,
    doctorId: string,
    patientId: string, // Add explicit patientId parameter
    ...
    try {
        // Determine disease type from diagnosis
        ...
        // Also create the doctor-patient mapping
        createDoctorPatientMapping(doctorId, folder.patientId, diseaseType)
        
        console.log('Patient folder created/updated:', folder)
    } catch (error) {
        console.error('Error creating patient folder:', error)
    }
}

// Get patient folders for a doctor
