...
// Generate prescription from patient data
export function generatePrescription(
    ...
    const prescription: Prescription = {
        ...
        patientId: patientData.fullName.toLowerCase().replace(/\s+/g, '-') + '-' + patientData.age,
        doctorId,
        ...
        personalizedAlerts,
        diagnosis: `${patientData.diagnosis.primaryCategory}${patientData.diagnosis.subtype ? ' - ' + patientData.diagnosis.subtype : ''}`,
        instructions
    }
