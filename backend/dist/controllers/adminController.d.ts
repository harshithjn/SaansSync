...
export declare function fixApprovedDoctors(req: AuthedRequest, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
export declare function findPatientByPhone(req: AuthedRequest, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
