...
export default function CleanILDDashboard({ patientId, patientName, diagnosis, headless = false }: CleanILDDashboardProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const result = await createDailyLog(patientId, 'ILD', {
                patientId,
                aqi: aqiData,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
                    ...
                    <div className="space-y-10">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100/50 flex gap-5 items-start">
                                <Activity className="w-6 h-6 text-indigo-500 shrink-0 mt-1" />
                                <div>
                                    <p className="text-[10px] font-black text-indigo-500 uppercase tracking-widest mb-2">Clinical Note</p>
                                    <p className="text-xs text-slate-600 font-medium leading-relaxed">Ensure physical stability for at least 5 minutes before recording your resting SpO₂ baseline.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-16 pt-12 border-t border-slate-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20 gap-y-12">
                        {[
                            ...
                            { key: 'fatigue', label: 'Tiredness', icon: Clock }
